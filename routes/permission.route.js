...
router.delete("/soft/:id", verifyUser, checkPermission("permission:delete", softDeletePermission));
router.delete("/hard/:id", verifyUser, checkPermission("permission:delete", hardDeletePermission));
